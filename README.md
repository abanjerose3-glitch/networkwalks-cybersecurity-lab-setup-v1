...
The expected primary IPv4 address was confirmed:
...
A baseline snapshot named:

Week 1 - Lab Setup Complete

was created after the Kali lab setup was completed.

The snapshot was later restored during verification. After the network conflict was corrected, Kali successfully returned to:
